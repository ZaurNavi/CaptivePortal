...
def admin_web_config_from_settings(
    ...
    traffic_independent_ranges_enabled = _exact_bool(
        settings.get("web_admin_traffic_independent_ranges_enabled", "false"),
    ...
    values = {
        ...
        "max_concurrent_queries": _bounded_int(settings, "max_concurrent_queries", 4, 1, 8),
        "max_query_duration_seconds": _bounded_int(settings, "max_query_duration_seconds", 25, 1, 30),
