...
from app.config import (
    ...
    DEVICE_FINGERPRINT_EVIDENCE_ENABLED,
    DEVICE_FINGERPRINT_DB_PATH, DEVICE_FINGERPRINT_WRITER_LOCK_PATH,
    DEVICE_FINGERPRINT_BIND_ADDRESS, DEVICE_FINGERPRINT_PORT,
    DEVICE_FINGERPRINT_TLS_CERT_PATH, DEVICE_FINGERPRINT_TLS_KEY_PATH,
    DEVICE_FINGERPRINT_API_ALLOWED_NETWORKS,
    DEVICE_FINGERPRINT_PRODUCERS_JSON,
    DEVICE_FINGERPRINT_RETENTION_DAYS,
    DEVICE_FINGERPRINT_MAX_FUTURE_SKEW_SECONDS,
    DEVICE_FINGERPRINT_MAX_DELAYED_EVENT_AGE_SECONDS,
    DEVICE_FINGERPRINT_MAX_DB_BYTES,
    DEVICE_FINGERPRINT_MAX_HTTP_REQUEST_BYTES,
    DEVICE_FINGERPRINT_MAX_EVENTS_PER_BATCH,
    DEVICE_FINGERPRINT_MAX_PAYLOAD_BYTES,
    DEVICE_FINGERPRINT_MAX_CONCURRENT_INGEST_REQUESTS,
    ...
    WEB_ADMIN_HOME_AP_24H_ENABLED,
    WEB_ADMIN_HOME_AP_24H_REFRESH_SECONDS,
    WEB_ADMIN_HOME_AP_24H_REQUEST_TIMEOUT_SECONDS,
    WEB_ADMIN_HOME_AP_24H_TELEMETRY_ENABLED,
...
def get_settings() -> dict:
    ...
    return {
        ...
        "device_fingerprint_evidence_enabled": DEVICE_FINGERPRINT_EVIDENCE_ENABLED,
        "device_fingerprint_db_path": DEVICE_FINGERPRINT_DB_PATH,
        "device_fingerprint_writer_lock_path": DEVICE_FINGERPRINT_WRITER_LOCK_PATH,
        "device_fingerprint_bind_address": DEVICE_FINGERPRINT_BIND_ADDRESS,
        "device_fingerprint_port": DEVICE_FINGERPRINT_PORT,
        "device_fingerprint_tls_cert_path": DEVICE_FINGERPRINT_TLS_CERT_PATH,
        "device_fingerprint_tls_key_path": DEVICE_FINGERPRINT_TLS_KEY_PATH,
        "device_fingerprint_api_allowed_networks": DEVICE_FINGERPRINT_API_ALLOWED_NETWORKS,
        "device_fingerprint_producers_json": DEVICE_FINGERPRINT_PRODUCERS_JSON,
        "device_fingerprint_retention_days": DEVICE_FINGERPRINT_RETENTION_DAYS,
        "device_fingerprint_max_future_skew_seconds": DEVICE_FINGERPRINT_MAX_FUTURE_SKEW_SECONDS,
        "device_fingerprint_max_delayed_event_age_seconds": DEVICE_FINGERPRINT_MAX_DELAYED_EVENT_AGE_SECONDS,
        "device_fingerprint_max_db_bytes": DEVICE_FINGERPRINT_MAX_DB_BYTES,
        "device_fingerprint_max_http_request_bytes": DEVICE_FINGERPRINT_MAX_HTTP_REQUEST_BYTES,
        "device_fingerprint_max_events_per_batch": DEVICE_FINGERPRINT_MAX_EVENTS_PER_BATCH,
        "device_fingerprint_max_payload_bytes": DEVICE_FINGERPRINT_MAX_PAYLOAD_BYTES,
        "device_fingerprint_max_concurrent_ingest_requests": DEVICE_FINGERPRINT_MAX_CONCURRENT_INGEST_REQUESTS,
        ...
        "web_admin_home_ap_24h_enabled": WEB_ADMIN_HOME_AP_24H_ENABLED,
        "web_admin_home_ap_24h_refresh_seconds": WEB_ADMIN_HOME_AP_24H_REFRESH_SECONDS,
        "web_admin_home_ap_24h_request_timeout_seconds": WEB_ADMIN_HOME_AP_24H_REQUEST_TIMEOUT_SECONDS,
        "web_admin_home_ap_24h_telemetry_enabled": WEB_ADMIN_HOME_AP_24H_TELEMETRY_ENABLED,
        "web_admin_home_ap_24h_telemetry_initial_delay_seconds": WEB_ADMIN_HOME_AP_24H_TELEMETRY_INITIAL_DELAY_SECONDS,
        "web_admin_home_ap_24h_telemetry_interval_seconds": WEB_ADMIN_HOME_AP_24H_TELEMETRY_INTERVAL_SECONDS,
        "web_admin_traffic_enabled": WEB_ADMIN_TRAFFIC_ENABLED,
        "web_admin_traffic_history_enabled": WEB_ADMIN_TRAFFIC_HISTORY_ENABLED,
        ...
        "web_admin_traffic_ap_share_enabled": WEB_ADMIN_TRAFFIC_AP_SHARE_ENABLED,
        "web_admin_traffic_online_guests_enabled": (
            WEB_ADMIN_TRAFFIC_ONLINE_GUESTS_ENABLED
        ),
        "web_admin_traffic_completed_sessions_enabled": (
